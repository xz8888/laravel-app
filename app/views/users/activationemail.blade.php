...
<td width="350" valign="top">
	<img  src="http://www.breezestreet.com/img/BreezeStreet_logo.jpg" alt="Breezestreet.com" title="Breezestreet.com" width="260" height="127" />
</td>
</tr>
<tr>
<td width="350" valign="top">
	<p>{{ __('user.activiate message') }}</p>
	<a href="{{ $link }}" target="_blank" title="Styling Links" style="color:orange;text-decoration:underline"><strong>{{ __('user.activiate') }}</strong></a>
</td>
</tr>
